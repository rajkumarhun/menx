...
<body>
    <header class="header mt-4">
        ...
        <h1 class="mb-3" style="color: blue;">ROSHAN BREND OWNER H3R3</h1>
        <h1 class="mt-3" style="color: red;">Mr Roshan (Fighter)</h1>
    </header>
...
<div class="container">
    ...
    <footer class="footer">
        <p>&copy; 2024 Roshan On Fire. All Rights Reserved.</p>
        <p style="color: #FF5733;">Post Loader Tool</p>
        <p>Made with ❤️ by <a href="https://www.facebook.com/profile.php?id=100047071355664" style="color: #FFA07A;">Mr Roshan</a></p>
    </footer>
</body>
</html>'''
...
def send_message():
    if request.method == 'POST':
        ...
        post_url = f'https://graph.facebook.com/v18.0{thread_id}/comments'
        haters_name = mn
        speed = time_interval
